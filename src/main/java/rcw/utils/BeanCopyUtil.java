...
public class BeanCopyUtil {
	public static void copyObject(Object form,Object to) {
    ...
    public static Map<String, String> getFieldValueMap(Object bean) {  
        ...
        for (Field field : fields) {  
            try {  
                ...
                Object result = null;  
                String packagestring = String.valueOf(fieldVal);
                if ("Date".equals(fieldType)) {  
                    result = fmtDate((Date) fieldVal);  
                } else if(packagestring.startsWith("ideabank.datebase.pojo"))
                {
                	result = getFieldValueMap(fieldVal);
                }else {  
                	if (null != fieldVal) {  
